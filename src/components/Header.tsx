...
export const Header = () => {
  ...
  return (
    <div className="relative min-h-screen grid md:grid-cols-2 gap-0 overflow-hidden">
      ...
      <div className="relative flex flex-col justify-center px-6 sm:px-8 md:px-16 lg:px-24 py-16 sm:py-20 md:py-32 -mt-16 sm:-mt-20 md:mt-0 md:-ml-16 z-10 bg-paper/95">
        <EditorialLabel className="mb-6 sm:mb-8 md:mb-12 animate-slide-up">
          {t('header.subtitle')}
        </EditorialLabel>

        <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl xl:text-[10rem] font-display text-dark-brown mb-8 animate-slide-up animation-delay-200 leading-[0.9] tracking-tight">
